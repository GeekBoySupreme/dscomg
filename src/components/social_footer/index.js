		...
		return (
			<div class={style.social_footer}>
				<div class={style.social_body}>
					...
					<div>
						<a alt="DSC OMG Twitter Handle" href="#" target="_blank" rel="noopener noreferrer">
							<svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
								<title>Developer Student Clubs OMG on Twitter</title>
				...
				<div class={style.social_gif}>
					...
					<svg height="201" viewBox="0 0 409 501" width="209" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd" stroke-linecap="square" stroke-width="10"><path d="m11.929 116.176h267.61v248.957" stroke="#fad2cf"></path><path d="m11.929 365.133h386.668m-247.025-125.619v-227.584h-139.643m0 227.584v248.647" stroke="#fce8e6"></path><path d="m11.929 121.176v118.338h386.668v247.647" stroke="#ee675c"></path><path d="m399.597 488.161h-387.668" stroke="#fce8e6"></path><path d="m11.929 11.93v104.246" stroke="#fad2cf"></path></g></svg>

					<svg width="140" height="90" viewBox="0 0 299 150" xmlns="http://www.w3.org/2000/svg">
						<path d="M293.916 5C291.29 82.77 227.634 145 149.5 145S7.71 82.77 5.084 5h288.832z" stroke="#FAD2CF" stroke-width="10" fill="none" fill-rule="evenodd"></path>
					</svg>

					<svg aria-hidden="true" width="112" height="80" viewBox="0 0 512 257" xmlns="http://www.w3.org/2000/svg">
						<path d="M488 245c0-128.683-103.87-233-232-233S24 116.317 24 245h464z" stroke="#1a73e8" stroke-width="18" fill="none"></path>
					</svg>
				</div>
			</div>
		);
