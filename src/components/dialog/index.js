...
export default class CustomDialog extends Component {
	...
	constructor(props) {
		...
		if (navigator.share) {
			...
			console.log(this.state.supportShare);
		}
	}
		...
		return (
			<Dialog onCancel={this.onClose(type)} onAccept={this.onClose(type)} class={style.dialog} ref={scrollingDlg => { this.scrollingDlg = scrollingDlg; }}>
				<div class={style.dialog_header}>
					...
					<div class={style.header_text}>[Meetup] Community Groups - North America</div>
				...
				<div class={style.dialog_body} scrollable>
					<div class={style.subtitle}>11:30AM - 12:15PM, Hall 2</div>
					<p class={style.dialog_body_description}>Are you a community enthusiast, organizer, expert, or community mentor based in the USA or Canada? Come to this meetup to connect with fellow organizers, chat with experts from your region, and learn about the latest updates to the Google Developers Community Groups program.</p>
